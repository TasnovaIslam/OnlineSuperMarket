...
eBuy
    ...
    .controller('adminCtrl', function ($scope, $window, $location, $http, adminSvc) {
        ...
        var catServiceBase = 'http://localhost:9059/odata/Categories';
        var subCatServiceBase = 'http://localhost:9059/odata/SubCategories';
        var supplierBase = 'http://localhost:9059/odata/Suppliers';
        var productBaseVm = 'http://localhost:9059/odata/VM_ProductCategory';
        var productBase = 'http://localhost:9059/odata/Products';
        var orderBase = 'http://localhost:9059/odata/Orders';
        var orderDetailsBase = 'http://localhost:9059/odata/OrderDetails';
        var subCatServiceBaseVm = 'http://localhost:9059/odata/VM_SubCategory';
        ...
        $scope.getProdByCat = function (catId) {
            $http({
                method: 'GET',
                url: 'http://localhost:9059/odata/Categories(' + catId + ')/Products'
            })
                .then(function (result) {
                    $scope.prodByCat = {};
